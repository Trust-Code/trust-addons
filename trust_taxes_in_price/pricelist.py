...
class l10n_br_sale_order_line (orm.Model):
    ...
    def product_id_change(self, cr, uid, ids, pricelist, product, qty=0,
        ...
        if (not uom) and (not uos):
            ...
            result['th_weight'] = result[
                'product_uom_qty'] * product_obj.weight
                    ...
                    if res:
                        ...
                        if price is not False:
                            ...
                            if surcharge and 'uom' in context:
                                ...
                                surcharge = product_uom_obj._compute_price(
                                    cr, uid, uom.id, surcharge, context['uom'])
                            price_limit = price
